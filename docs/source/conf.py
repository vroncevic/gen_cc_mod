...
Copyright
    ...
    gen_cc_mod is distributed in the hope that it will be useful, but
...
project: str = 'gen_cc_mod'
project_copyright: str = '2024, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '2.0.0'
release: str = 'https://github.com/vroncevic/gen_cc_mod/releases'
...
htmlhelp_basename: str = 'gen_cc_moddoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_cc_mod.tex', 'gen_cc_mod Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_cc_mod', 'gen_cc_mod Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_cc_mod', 'gen_cc_mod Documentation', author, 'gen_cc_mod',
