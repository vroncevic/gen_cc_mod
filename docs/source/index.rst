...
.. |GitHub shell checker| image:: https://github.com/vroncevic/gen_cc_mod/actions/workflows/gen_cc_mod_shell_checker.yml/badge.svg
   :target: https://github.com/vroncevic/gen_cc_mod/actions/workflows/gen_cc_mod_shell_checker.yml
...
.. code-block:: bash
   ...
   tar xvzf gen_cc_mod-4.0.tar.gz
   cd gen_cc_mod-4.0
   cp -R ~/sh_tool/bin/   /root/scripts/gen_cc_mod/ver.4.0/
   cp -R ~/sh_tool/conf/  /root/scripts/gen_cc_mod/ver.4.0/
   cp -R ~/sh_tool/log/   /root/scripts/gen_cc_mod/ver.4.0/
...
Copyright (C) 2017 - 2026 by `vroncevic.github.io/gen_cc_mod <https://vroncevic.github.io/gen_cc_mod>`_
