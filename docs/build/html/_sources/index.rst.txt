...
.. code-block:: bash
   ...
   tar xvzf gen_cc_mod-3.0.tar.gz
   cd gen_cc_mod-3.0
   cp -R ~/sh_tool/bin/   /root/scripts/gen_cc_mod/ver.3.0/
   cp -R ~/sh_tool/conf/  /root/scripts/gen_cc_mod/ver.3.0/
   cp -R ~/sh_tool/log/   /root/scripts/gen_cc_mod/ver.3.0/
